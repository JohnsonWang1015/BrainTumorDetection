...
| IDH Mutation Classifier (MONAI DenseNet121 3D, TCGA-LGG, GT-mask ROI crop) | AUC | **Case 1.0000** (test, GT mask). With predicted-mask E2E (no jitter): AUC 0.50 (one hard case TCGA-CS-6669 confidently wrong). With **bbox-jitter retrain + bundle seg** E2E (`infer-monai-zoo`, calibrated threshold 0.0775): Accuracy **0.80**, AUC **0.75**, macro F1 0.69 — jitter recovered the hard case to p=0.243 (vs 0.9998 without jitter). Best operating point for production. |
